...
if __name__ == "__main__":
    df_20 = pd.read_csv('../results/results/CLL_MCL_ADA_BOOST/features/generation_20.csv', header=None, sep=',')
    df_01 = pd.read_csv('../results/results/CLL_MCL_ADA_BOOST/features/generation_1.csv', header=None, sep=',')
